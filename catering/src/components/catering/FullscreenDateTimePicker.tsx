        ...
        <div className="px-4 py-2">
          <Calendar
            ...
            classNames={{
              ...
              day: "h-12 flex-1 text-center rounded-full text-sm p-0 relative flex items-center justify-center",
              day_button: "h-12 w-12 p-0 font-normal rounded-full transition-colors flex items-center justify-center",
